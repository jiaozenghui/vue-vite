/**
 * Created by chengyezheng on 2017/9/28.
 */
var Dcms3d = function () {
    ...
    /*方法：初始化fid 画布所属div的Id*/
    dcms3D.prototype.initdcms3D = function (_fId, _option,_datajson) {
        //参数处理
    ...
    dcms3D.prototype.start = function () {
     ...
     //初始化渲染器
     dcms3D.prototype.initThree = function () {
             var _this = this;
     ...
     //初始化摄像机
     dcms3D.prototype.initCamera = function () {
             var _this = this;
     ...
     //创建场景
     dcms3D.prototype.initScene=function() {
         var _this = this;
         _this.scene = new THREE.Scene();
     }

     //添加对象
     dcms3D.prototype.addObject = function (_obj) {
         var _this = dcms3DObj;
     ...
     //创建网格线
     dcms3D.prototype.initHelpGrid = function () {
         var _this = this;
     ...
     //灯光布置
     dcms3D.prototype.initLight = function () {
             /*
     ...
     //创建鼠标控制器
     dcms3D.prototype.initMouseCtrl=function() {
         var _this = this;
     ...
     //控制器回调
     dcms3D.prototype.updateControls = function () {

            //controls.update();
         }

     //循环渲染界面
     dcms3D.prototype.animation = function () {
         var _this = dcms3DObj;
     ...
     /* 添加对象*/
     dcms3D.prototype.InitAddObject = function (_obj) {
             var _this = this;
                     ...
                     switch (_obj.objType) {
                             case 'cube':
                                 ...
                                 case 'emptyCabinet':
                                     ...
                                     var ammter = _obj.ammterData;
                                     var _tempObj1 = _this.createEmptyAmmter(_this, ammter);
                                     _this.addObject(_tempObj1);

                                     var _tempObj2 = _this.createEmptyAmmter2(_this, ammter);
                                     _this.addObject(_tempObj2);
                                     break;
                                case 'cloneObj':
     ...
     //创建地板
     dcms3D.prototype.CreateFloor = function (_obj) {
             var _this = this;
     ...
     //创建墙体
     dcms3D.prototype.CreateWall = function (_this, _obj) {
             if (_this == null) {
                       _this = this;
                  }
     ...
     //挖洞
     dcms3D.prototype.CreateHole = function (_this, _obj) {
              if (_this == null) {
                      _this = this;
                  }
     ...
     dcms3D.prototype.mergeModel = function (_this, mergeOP, _fobj, _sobj) {
             if (_this == null) {
                     _this = this;
                 }
     ...
     //创建盒子体
     dcms3D.prototype.createCube = function (_this, _obj) {
             if (_this == null) {
                     _this = this;
                 }
             ...
             if (_obj.style != null && typeof (_obj.style) != 'undefined' && _obj.style.skin != null && typeof (_obj.style.skin) != 'undefined') {
                     ...
                     //电表
                     skin_ammter_obj = _this.createSkinOptionOnj(_this, _length, _width, _obj.style.skin.skin_ammter, cubeGeometry, 12);
            ...
            cubeMaterialArray.push(new THREE.MeshLambertMaterial(skin_fore_obj));
             ...
             cubeMaterialArray.push(new THREE.MeshLambertMaterial(skin_ammter_obj));
             var cubeMaterials = new THREE.MeshFaceMaterial(cubeMaterialArray);
     ...
     //创建电表盒子体
     dcms3D.prototype.createAmmterCube = function (_this, _obj) {
        if (_this == null) {
            _this = this;
        }
        var _length = _obj.length || 1000;//默认1000
        ...
        if (_obj.style != null && typeof (_obj.style) != 'undefined' && _obj.style.skin != null && typeof (_obj.style.skin) != 'undefined') {
            ...
            skin_up_obj = _this.createSkinOptionOnj(_this, _length, _width, _obj.style.skin.skin_up, cubeGeometry, 4);
            //下
            skin_down_obj = _this.createSkinOptionOnj(_this, _length, _width, _obj.style.skin.skin_up, cubeGeometry, 6);
            //前
            skin_fore_obj = _this.createSkinOptionOnj(_this, _length, _width, _obj.style.skin.skin_up, cubeGeometry, 0);
            //后
            skin_behind_obj = _this.createSkinOptionOnj(_this, _length, _width, _obj.style.skin.skin_up, cubeGeometry, 2);
            //左
            skin_left_obj = _this.createSkinOptionOnj(_this, _length, _width, _obj.style.skin.skin_ammter, cubeGeometry, 8);
            //右
            skin_right_obj = _this.createSkinOptionOnj(_this, _length, _width, _obj.style.skin.skin_up, cubeGeometry, 10);
     ...
     //创建二维平面-长方形
     dcms3D.prototype.createPlaneGeometry = function (_this,_obj) {
                 //options={
                 //    width:0,
                   //    height:0,
                  //    pic:"",
     ...
     //创建空柜子
     dcms3D.prototype.createEmptyCabinet = function (_this, _obj) {
              var _this = dcms3DObj;
              //创建五个面
              //上
              var upobj= {
             ...
             //     name: '',
             //     objType: 'cube',
             //     length: _obj.size.length/10,
             //     width: _obj.size.thick,
             //     height: _obj.size.height/10,
             //     x: 100,
             //     y: -(_obj.size.height / 2 - _obj.size.thick / 2),
             //     z: 0 - (_obj.size.width / 2 - _obj.size.thick / 2) - 1,
             //     style: {
             //         skinColor: _obj.skin.skinColor,
             //         skin: _obj.ammterData.skin.skin_up.skin,
             //     }
             // }
             // var ammtercube = _this.createAmmterCube(_this, ammterobj);
             // var Cabinet = _this.mergeModel(_this, '+', upcube, ammtercube);
              ...
              var Rightcube = _this.createCube(_this, Rightobj);
                Cabinet = _this.mergeModel(_this, '+', upcube, Rightcube);
            //前
             var Foreobj = {
                 show: true,
                 uuid:"",
             ...
             var forcube = _this.createCube(_this, Foreobj);
             Cabinet = _this.mergeModel(_this, '+', Cabinet, forcube);
     ...
     //创建电表
     dcms3D.prototype.createEmptyAmmter = function (_this, _obj) {
         //电表
         var ammterobj = {
             show: true,
             uuid: "",
             ...
             width: _obj.size.thick,
             height: _obj.size.height,
             x: _obj.position.x+30,
             y: (_obj.size.height / 2 - _obj.size.thick / 2)+165,
             z: _obj.position.z - 37,
             style: {
                 skinColor: _obj.skin.skinColor,
                 skin: _obj.skin.skin_up.skin,
             }
         ...
         var tempobj = new THREE.Object3D();
         tempobj.add(ammtercube);
         tempobj.name = _obj.name;
         tempobj.uuid = _obj.uuid;
         ammtercube.name = _obj.shellname,
             _this.objects.push(ammtercube);
         tempobj.position = ammtercube.position;
         return tempobj;
     }

     //创建电表
     dcms3D.prototype.createEmptyAmmter2 = function (_this, _obj) {
        //电表
        var ammterobj = {
            show: true,
            uuid: "",
     ...
     //创建玻璃
     dcms3D.prototype.createGlasses = function (_this, _obj) {
          var _this = dcms3DObj;
     ...
     //创建皮肤
     dcms3D.prototype.createSkin = function (flength,fwidth,_obj) {
     ...
     //创建皮肤参数对象
     dcms3D.prototype.createSkinOptionOnj = function (_this, flength, fwidth, _obj, _cube, _cubefacenub) {
     ...
     dcms3D.prototype.commonFunc={
            ...
            if ( parameters === undefined ) parameters = {};
             ...
             var message = parameters.hasOwnProperty("message") ? parameters["message"] : "hellodcms3D";
     ...
     dcms3D.prototype.loadObj = function (_obj) {
     ...
     //添加按钮
     dcms3D.prototype.addBtns = function (_btnobjs) {
         var _this = dcms3DObj;
     ...
     var dbclick =0;
     dcms3D.prototype.onDocumentMouseDown = function (event) {
             dbclick++;
             var _this = dcms3DObj;
     ...
     dcms3D.prototype.onDocumentMouseMove = function (event) {
             event.preventDefault();
             var _this = dcms3DObj;
     ...
     dcms3D.prototype.addTestObj = function () {
