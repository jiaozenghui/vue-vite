...
function threeStart() {
    ...
    var Aobjects = {
        objects: [
            //地板
            {
                ...
                style: {
                    ...
                    skin: {
                        skin_up: {
                            skinColor: 0x98750f,
                            imgurl:"./static/jquery/three/img/floor.png",
                            repeatx: true,
                            repeaty: true,
                            width: 128,
                            height: 128
                        ...
                        childrens: [
                            ...
                            },
                            {
                                ...
                                skin: {
                                    ...
                                    skin_left: {
                                        skinColor: 0x51443e,
                                        imgurl:"./static/jquery/three/img/door_left.png"
                                    },
                                    skin_right: {
                                        skinColor: 0x51443e,
                            ...
                            },
                            {
                                ...
                                skin: {
                                    ...
                                    skin_left: {
                                        skinColor: 0x333333,
                                        imgurl:"./static/jquery/three/img/doorControl.png"
                                    },
                                    skin_right: {
                                        skinColor: 0x333333,
                                    }
            ...
            //玻璃
            {
                ...
                width: 500,
                height: 200,
                pic:"./static/jquery/three/img/glass.jpg",
                transparent: true,
                opacity: 1,
            ...
            //空调
            {
                ...
                style: {
                    ...
                    skin: {
                        skin_fore: {
                            imgurl:"./static/jquery/three/img/air.png"
                        },
                    }
                }
            },
            ...
            //温室度
            {
                ...
                width: 50,
                height: 50,
                pic:"./static/jquery/three/img/damp.jpg",
                transparent: true,
                opacity: 1,
            ...
            //机柜1-1 --原型
            {
                ...
                doors: {
                    ...
                    skins:[ {
                        skinColor: 0x333333,
                        skin_fore: {
                            imgurl:"./static/jquery/three/img/rack_door_back.png"
                        },
                        skin_behind: {
                            imgurl:"./static/jquery/three/img/rack_front_door.png"
                        }
                    }]
                },
                skin:{
                    ...
                    skin_up: {
                        skin:{
                            skinColor: 0xff0000,
                            skin_up: {
                                imgurl:"./static/jquery/three/img/rack_door.png"
                            },
                            skin_down: {
                                imgurl:"./static/jquery/three/img/rack_door.png"
                            },
                            ...
                            skin_left: {
                                imgurl:"./static/jquery/three/img/rack_left_door.png"
                            },
                            skin_right: {
                                imgurl:"./static/jquery/three/img/rack_left_door.png"
                            },
    ...
    msjstation.initdcms3D('canvas-frame', initOption, Aobjects);
    msjstation.start();
};


function opcabinetdoor(obj) {
    var doorstate = "close";
    var tempobj = null;
    if (obj.doorState != null && typeof (obj.doorState) != 'undefined') {
        doorstate = obj.doorState;
        ...
        var objparent = obj.parent;
        tempobj = new THREE.Object3D();
        tempobj.position.set(obj.position.x, obj.position.y, obj.position.z + obj.geometry.parameters.depth / 2);
...
function openRightDoor(obj,func) {
    var doorstate = "close";
    var tempobj = null;
    if (obj.doorState != null && typeof (obj.doorState) != 'undefined') {
        doorstate = obj.doorState;
